...
transPics = function(pic1,pic2,blackNwhite=c(0,1)) {
  ...
  grey = adjustPicture(grey,bsh=c(100,100,100),pixels=max(cwh),imageRotate=90,aspect=(cwh[2]/cwh[1]),return=0)
  ...
  tmp1 = magick::image_composite(pic1,grey, operator="multiply" )
  tmp2 = magick::image_composite(pic2,magick::image_negate(grey), operator="multiply" )
  tmp3 = magick::image_composite(tmp1,tmp2, operator="add" )
