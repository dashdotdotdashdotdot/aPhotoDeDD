...
This notebook shows how to use some of the tools in the package _aPhotoDeDD_.^[current location is (https://github.com/dashdotdotdashdotdot/aPhotoDeDD)] As this is an R Notebook, you can read the .html version on a browser or you can bring up the .Rmd version in Rstudio and run it line by line and make changes as desired. The annimation that this program produces is posted on the instagram site of @dashdotdotdashdot: [instagram](https://www.instagram.com/p/CmCN8AhuJXl/).  The idea is to run it once at a low resolution first with a small number of frames to see that it works before committing to creating  a relatively large .gif file (over 300 megabytes).  To load to instagram, I convert to an .mp4 file.
