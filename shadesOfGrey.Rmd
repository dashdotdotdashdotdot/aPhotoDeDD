...
This notebook demonstrates some of the basic photo manipulation that I like with these tools.  One image caps all the pixels whose that are lighter than a grey value to the grey value.  The other sets all the pixels that are less than the grey texture.  The iconic image of Marilyn Monroe is in the public domain:
